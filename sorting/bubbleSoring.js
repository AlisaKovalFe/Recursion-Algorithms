// на стр. 18 при i = 0 на последней итерации 3 нужно сравнить с arr.length - 0, то есть с элементом, которого не существует, почему скрипт не падает? И зачем вообще i вычиать, без него тоже работает
